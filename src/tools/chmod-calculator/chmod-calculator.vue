...
const scopes: { scope: Scope; title: string }[] = [
  { scope: 'read', title: t('tools.chmod-calculator.read') + ' (4)' },
  { scope: 'write', title: t('tools.chmod-calculator.write') + ' (2)' },
  { scope: 'execute', title: t('tools.chmod-calculator.execute') + ' (1)' },
];
